...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(width, height), "SFML PlayGround", sf::Style::Default);
	...
	gamestate.GameLoop(gamestate.input, sprite1, window, map, font1, gamestate.input.animMan, gamestate.defview, height, width);
